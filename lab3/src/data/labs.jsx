...
const labs = [
    {
      ...
      content: {
        ...
        6: <h1>Hello</h1>,
        7: <img src='https://avatars.mds.yandex.net/i?id=dc306a48eadd16911f39ab70cf8708090e50a571-4814374-images-thumbs&n=13'/>
      }, 
    },
    {
      id: 2,
    ...
    },
    {
      ...
      content: {
        ...
        3: {
            1: 'useEffect на монтировании и размонтировании страницы'
        },
        4: 'Внедрить в проект react-router',
        5: {
          1: 'В меню проекта реализовать ссылки переходы',
          2: 'В Content реализовать обработчик роутов'
        },
        6: "Внедрить в проект redux",
        7: {
